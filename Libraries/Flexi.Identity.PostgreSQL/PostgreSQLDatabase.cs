...
namespace AspNet.Identity.PostgreSQL
{
    ...
    public class PostgreSQLDatabase : IDisposable
    {
        ...
        {
            string connectionString = ConfigHelper.Instance.GetDBContext();//ConfigurationManager.ConnectionStrings[connectionStringName].ConnectionString;
        ...
        {
            RegistryKey registryKey = Registry.CurrentUser.OpenSubKey(@"SOFTWARE\" + path);
