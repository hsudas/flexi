...
namespace Flexi.Model.Entity.Amazon
{
    ...
    public class Sku
    {
        ...
        [Column("quantitycheckdate")]
        public DateTime? QuantityCheckDate { get; set; }
        ...
        [Column("quantitymrc")]
        public int? QuantityMrc { get; set; }
        [Column("totalsupplyquantity")]
        public int? TotalSupplyQuantity { get; set; }
        [Column("departmentcode")]
        public string DepartmentCode { get; set; }
        [Column("nonprime"), DefaultValue(0)]
        ...
        private string DebugMessage
        {
            get
            {
                return $"Asin:{Asin}, Sku:{SKU}, cost: {Cost}, Title: {Title}";
            }
        }
    }
}
