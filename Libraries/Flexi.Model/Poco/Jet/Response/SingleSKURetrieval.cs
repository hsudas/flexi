...
{
    public class SingleSKURetrieval
    {
        public string status { get; set; }
        public List<string> sub_status { get; set; }
        public string product_title { get; set; }
        public int jet_browse_node_id { get; set; }
        public List<StandardProductCodeResp> standard_product_codes { get; set; }
        ...
        public List<InventoryByFulfillmentNode> inventory_by_fulfillment_node { get; set; }
        public DateTime inventory_last_update { get; set; }
    }


    public class StandardProductCodeResp
    {
    ...
    public class InventoryByFulfillmentNode
    {
