...
namespace Flexi.Model.Poco.AmazonMWS.Report.Response
{
    ...
    [XmlRoot(ElementName = "FeeList", Namespace = "http://mws.amazonservices.com/Finances/2015-05-01")]
    ...
    [XmlRoot(ElementName = "ServiceFeeEvent", Namespace = "http://mws.amazonservices.com/Finances/2015-05-01")]
    public class ServiceFeeEvent
    {
        [XmlElement(ElementName = "FeeList", Namespace = "http://mws.amazonservices.com/Finances/2015-05-01")]
        public FeeList FeeList { get; set; }
    }

    [XmlRoot(ElementName = "ServiceFeeEventList", Namespace = "http://mws.amazonservices.com/Finances/2015-05-01")]
    public class ServiceFeeEventList
    {
        [XmlElement(ElementName = "ServiceFeeEvent", Namespace = "http://mws.amazonservices.com/Finances/2015-05-01")]
        public List<ServiceFeeEvent> ServiceFeeEvent { get; set; }
    }
    ...
    public class ShipmentItem
    {
        ...
        [XmlElement(ElementName = "ItemFeeAdjustmentList", Namespace = "http://mws.amazonservices.com/Finances/2015-05-01")]
        public ItemFeeAdjustmentList ItemFeeAdjustmentList { get; set; }
        [XmlElement(ElementName = "OrderAdjustmentItemId", Namespace = "http://mws.amazonservices.com/Finances/2015-05-01")]
        public string OrderAdjustmentItemId { get; set; }
        [XmlElement(ElementName = "ItemChargeAdjustmentList", Namespace = "http://mws.amazonservices.com/Finances/2015-05-01")]
        public ItemChargeAdjustmentList ItemChargeAdjustmentList { get; set; }
        [XmlElement(ElementName = "PromotionAdjustmentList", Namespace = "http://mws.amazonservices.com/Finances/2015-05-01")]
        public PromotionAdjustmentList PromotionAdjustmentList { get; set; }
    }

    [XmlRoot(ElementName = "PromotionAdjustmentList", Namespace = "http://mws.amazonservices.com/Finances/2015-05-01")]
    public class PromotionAdjustmentList
    {
    ...
    public class ShipmentEvent
    {
        ...
        [XmlElement(ElementName = "ShipmentItemAdjustmentList", Namespace = "http://mws.amazonservices.com/Finances/2015-05-01")]
        public ShipmentItemAdjustmentList ShipmentItemAdjustmentList { get; set; }
    }
    ...
    [XmlRoot(ElementName = "ItemFeeAdjustmentList", Namespace = "http://mws.amazonservices.com/Finances/2015-05-01")]
    public class ItemFeeAdjustmentList
    {
        [XmlElement(ElementName = "FeeComponent", Namespace = "http://mws.amazonservices.com/Finances/2015-05-01")]
        public List<FeeComponent> FeeComponent { get; set; }
    }

    [XmlRoot(ElementName = "ItemChargeAdjustmentList", Namespace = "http://mws.amazonservices.com/Finances/2015-05-01")]
    public class ItemChargeAdjustmentList
    {
        [XmlElement(ElementName = "ChargeComponent", Namespace = "http://mws.amazonservices.com/Finances/2015-05-01")]
        public List<ChargeComponent> ChargeComponent { get; set; }
    }

    [XmlRoot(ElementName = "ShipmentItemAdjustmentList", Namespace = "http://mws.amazonservices.com/Finances/2015-05-01")]
    public class ShipmentItemAdjustmentList
    {
        [XmlElement(ElementName = "ShipmentItem", Namespace = "http://mws.amazonservices.com/Finances/2015-05-01")]
        public List<ShipmentItem> ShipmentItem { get; set; }
    }

    [XmlRoot(ElementName = "GuaranteeClaimEventList", Namespace = "http://mws.amazonservices.com/Finances/2015-05-01")]
    public class GuaranteeClaimEventList
    {
        [XmlElement(ElementName = "ShipmentEvent", Namespace = "http://mws.amazonservices.com/Finances/2015-05-01")]
        public List<ShipmentEvent> ShipmentEvent { get; set; }
    }

    [XmlRoot(ElementName = "ChargebackEventList", Namespace = "http://mws.amazonservices.com/Finances/2015-05-01")]
    public class ChargebackEventList
    {
        [XmlElement(ElementName = "ShipmentEvent", Namespace = "http://mws.amazonservices.com/Finances/2015-05-01")]
        public List<ShipmentEvent> ShipmentEvent { get; set; }
    }

    [XmlRoot(ElementName = "LoanAmount", Namespace = "http://mws.amazonservices.com/Finances/2015-05-01")]
    ...
    [XmlRoot(ElementName = "LoanServicingEvent", Namespace = "http://mws.amazonservices.com/Finances/2015-05-01")]
    public class LoanServicingEvent
    {
        [XmlElement(ElementName = "SourceBusinessEventType", Namespace = "http://mws.amazonservices.com/Finances/2015-05-01")]
        public string SourceBusinessEventType { get; set; }
        [XmlElement(ElementName = "LoanAmount", Namespace = "http://mws.amazonservices.com/Finances/2015-05-01")]
        public LoanAmount LoanAmount { get; set; }
    }

    [XmlRoot(ElementName = "LoanServicingEventList", Namespace = "http://mws.amazonservices.com/Finances/2015-05-01")]
    public class LoanServicingEventList
    {
        [XmlElement(ElementName = "LoanServicingEvent", Namespace = "http://mws.amazonservices.com/Finances/2015-05-01")]
        public LoanServicingEvent LoanServicingEvent { get; set; }
    }

    [XmlRoot(ElementName = "RefundEventList", Namespace = "http://mws.amazonservices.com/Finances/2015-05-01")]
    public class RefundEventList
    {
        [XmlElement(ElementName = "ShipmentEvent", Namespace = "http://mws.amazonservices.com/Finances/2015-05-01")]
        public List<ShipmentEvent> ShipmentEvent { get; set; }
    }
    ...
    public class AdjustmentEventList
    {
        ...
        public List<AdjustmentEvent> AdjustmentEvent { get; set; }
    }
    ...
    public class FinancialEvents
    {
        ...
        public GuaranteeClaimEventList GuaranteeClaimEventList { get; set; }
        [XmlElement(ElementName = "ChargebackEventList", Namespace = "http://mws.amazonservices.com/Finances/2015-05-01")]
        public ChargebackEventList ChargebackEventList { get; set; }
    ...
    [XmlRoot(ElementName = "ListFinancialEventsResult", Namespace = "http://mws.amazonservices.com/Finances/2015-05-01")]
    ...
    [XmlRoot(ElementName = "ListFinancialEventsResponse", Namespace = "http://mws.amazonservices.com/Finances/2015-05-01")]
    public class ListFinancialEventsResponse
    {
        [XmlElement(ElementName = "ListFinancialEventsResult", Namespace = "http://mws.amazonservices.com/Finances/2015-05-01")]
        public ListFinancialEventsResult ListFinancialEventsResult { get; set; }
